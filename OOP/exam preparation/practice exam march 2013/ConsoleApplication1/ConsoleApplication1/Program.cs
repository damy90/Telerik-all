...
namespace TradeAndTravel
{
    ...
    {
        protected InteractionManagerExtended extendedInteractionManager;

        public EngineExtended(InteractionManagerExtended interactionManager)
           : base(interactionManager)
        {
            this.extendedInteractionManager = interactionManager;
        }
    }
}
