namespace Computers.UI.Console.AbstractComputerFactory
{
    ...
    {
        private const byte LaptopCpuBits = 32;
        private const byte LaptopCpuCores = 4;
        private const byte LaptopRam = 8;
        private const int LaptopHardDriveCapacity = 1000;

        private const byte ServerCpuBits = 64;
        private const byte ServerCpuCores = 8;
        private const byte ServerRam = 64;
