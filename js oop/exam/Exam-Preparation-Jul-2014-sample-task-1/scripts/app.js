(function () {
    require(['structures'], function (structures) {
        ...
        /*console.dir(JSON.stringify(greekHeroesSection.getData()));
        console.dir(JSON.stringify(greekHeroesSection));
        greekHeroesSection.add('');*/
    });
   ...
   */
    //console.log(JSON.stringify(JSON.parse('[{ "title": "Superheroes", "items": [{ "content": "Batman" }, { "content": "Ironman" },{ "content": "Superman" }, { "content": "Wonderwoman" }, { "content": "The Flash" }, { "content": "Spiderman" }, { "content": "Captain America" },{ "content": "The Hulk" }, { "content": "Green arrow" }, { "content": "Green Lantern" }]},{ "title": "Greek Heroes","items": [{ "content": "Ajax" }, { "content": "Hercules" }, { "content": "Jason" }, { "content": "Perseus" }, { "content": "Odysseus" }]}, { "title": "Bulgarian Heroes","items": [{ "content": "Hristo Botev" }, { "content": "Vasil Levski" }, { "content": "Chavdar Vyivoda" }]}]')));
